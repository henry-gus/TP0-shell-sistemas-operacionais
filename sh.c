...
main(void)
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    * O if detecta o comando "cd". Ele é tratado separadamente porque
    * cd precisa alterar o diretório do processo atual (shell),
    * e não de um processo filho. Se fosse executado com fork,
    * a mudança não afetaria o shell principal.
    */
